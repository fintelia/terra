...
fn main(
    ...
    let texcoord = layer_texcoord(node.layer_extents[TREE_ATTRIBUTES_LAYER], texcoord);
    ...
    let texcoord = layer_texcoord(node.layer_extents[DISPLACEMENTS_LAYER], texcoord);
